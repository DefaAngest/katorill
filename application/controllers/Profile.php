...
class Profile extends MY_Controller 
{
    ...
    {
        $data['title']      = 'Profile';
        $data['content']    = $this->profile->select([
                'user.id', 'user.nama', 'user.email', 'user.password', 'user.user_id', 'data_pengguna.image', 'data_pengguna.alamat', 'data_pengguna.jenis_kelamin as jkl', 'data_pengguna.no_tlp as tlp'
            ])
            ->join('data_pengguna', 'user.id = data_pengguna.id_user')
...
//        var_dump($data); die;
    ...
    {
        $data['content'] = $this->profile->where('id', $id_user)->first();
