...
<head>
	...
	<title><?= isset($title) ? $title : "Katori" ?> - Pemesanan Catering</title>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
        ...
        <script type="text/javascript"
            ...
            data-client-key="<SB-Mid-client-MYqRM65UVpKKuY5w>"></script>
        ...
        <style>
            ...
            .fixed-size-img-home {
                width: 100%;
                height: 300px; /* Ubah sesuai kebutuhan Anda */
                object-fit: cover;
            }
            .fixed-size-card-home {
                width: 100%;
                height: 600px; /* Ubah sesuai kebutuhan Anda */
                object-fit: cover;
            }
            .short-text {
                display: inline;
...
<body>
	<!-- Navbar -->
	<?php $this->load->view('partition/navbar') ?>
	<!-- End Navbar -->
